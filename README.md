# GlyphCraft Icons — Setup Guide (Hinglish)
...
| `ADMIN_EMAIL` | Aapka apna admin email (jo aap login me use karenge) |
| `ADMIN_PASSWORD_SALT` | Neeche diya hua salt value |
| `ADMIN_PASSWORD_HASH` | Neeche diya hua hash value |
