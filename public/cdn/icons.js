/*
 * ColorIconLab — permanent CDN script
...
(function () {
  ...
  function applyIcons(icons) {
    ...
    elements.forEach(function (el) {
      ...
      if (map[name]) {
        ...
        console.warn('[ColorIconLab] Icon not found: "' + name + '"');
      }
    });
  }
  ...
  function loadAndRender() {
    fetch(API_BASE + '/api/icons')
      ...
      .catch(function (err) {
        console.error('[ColorIconLab] ' + err.message);
      });
  }
  ...
  window.ColorIconLab = { reload: loadAndRender };
})();
